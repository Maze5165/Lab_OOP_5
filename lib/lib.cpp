...
Longlong Longlong::add(const Longlong& o) const {
    return *this + o;
}

Longlong Longlong::sub(const Longlong& o) const {
    return *this - o;
}

Longlong Longlong::mul(const Longlong& o) const {
    return *this * o;
}

bool Longlong::equ(const Longlong& o) const {
    return *this == o;
}

bool Longlong::greater(const Longlong& o) const {
    return h > o.h || (h == o.h && l > o.l);
}

bool Longlong::less(const Longlong& o) const {
    return h < o.h || (h == o.h && l < o.l);
}